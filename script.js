/* ============================================================
   ...
   Replace TABLE_DATA with real fetch() calls to your MySQL
   backend later; everything else in this file stays the same.
   ============================================================ */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showTab(which) {
    ...
    formSignup.classList.toggle("panel-hidden", !isSignup);
    formLogin.classList.toggle("panel-hidden", isSignup);
  }
